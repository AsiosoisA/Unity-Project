...
public class PlayerLedgeClimbState : PlayerState
{
    ...
    {
        isTouchingCeiling = Physics2D.Raycast(cornerPos + (Vector2.up * 0.015f) + (Vector2.right * 0.015f), Vector2.up, playerData.standColliderHeight, core.CollisionSenses.WhatIsGround);
    }
    ...
    public Vector2 DetermineCornerPosition()
    {
        ...
        RaycastHit2D yHit = Physics2D.Raycast(core.CollisionSenses.LedgeCheck.position + (Vector3)(workspace), Vector2.down, core.CollisionSenses.LedgeCheck.position.y - core.CollisionSenses.LedgeCheck.position.y + 0.015f, core.CollisionSenses.WhatIsGround);
