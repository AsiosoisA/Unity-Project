...
public class PlayerDataManager : MonoBehaviour
{
    ...
    */
    ...
    private PlayerDataForSave data;
    public PlayerDataForSave Data 
    {
        get
        {
            if(data != null) return data;
            else{
                Debug.LogError("Warning!!!! 데이터 매니저가 데이터를 불러오기 전에 데이터 매니저의 데이터를 사용하려고 했습니다!");
                return null;
            }
        }
        set
    ...
    */
    ...
    public void Load(int slotNumber){       
        ...
        Data = new PlayerDataForSave(playerData); // 그 데이터를 기반으로 현재 들고 있는 playerData를 초기화한다!
    }
