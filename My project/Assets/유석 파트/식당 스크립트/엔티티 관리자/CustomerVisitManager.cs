...
public class CustomerVisitManager : MonoBehaviour
{
    ...
    [SerializeField] private int customerCount = 15; // 플레이어 데이터에서 일일 방문 손님 수를 얻어와야 함. 일단 임시값 사용.

    [SerializeField] private float peroid = 1.0f; // 식당에 손님을 입장시킬 주기. (peroid) 초 마다 손님을 입장시키고, 꽉 차면 대기시킴.
